<script>
    ...
    function initMap() {
            ...
            const map = new google.maps.Map(document.getElementById("map-party"), {
                ...
                heading: 0,
                tilt: 45,
                mapId: "f4792ebdc438caa1" // dark party map
            });
...
<div id="map-party" class="map-component {show ? ' show' : ''}"></div>
